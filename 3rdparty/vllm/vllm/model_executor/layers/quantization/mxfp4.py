...
class Mxfp4MoEMethod(FusedMoEMethodBase):
    ...
    def create_weights(self, layer: torch.nn.Module, num_experts: int,
        ...
        self.intermediate_size = intermediate_size_per_partition_after_pad  # 2944
        self.hidden_size = hidden_size                                      # 3072
        # Fused gate_up_proj (column parallel)
        w13_weight = torch.nn.Parameter(        # 32, 5888, 1536
            torch.zeros(
                num_experts,
        ...
        w13_weight_scale = torch.nn.Parameter(   # 32, 5888, 96
            torch.zeros(
                num_experts,
                2 * intermediate_size_per_partition_after_pad,
        ...
        w2_weight = torch.nn.Parameter(             # 32, 3072, 1472
            torch.zeros(
                num_experts,
                hidden_size,
        ...
        w2_weight_scale = torch.nn.Parameter(       # 32, 3072, 92
            torch.zeros(
                num_experts,
                hidden_size,
