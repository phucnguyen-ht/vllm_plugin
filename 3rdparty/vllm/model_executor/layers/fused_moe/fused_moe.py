...
def get_moe_sum_config(M, top_k, N):
    ...
    if moe_sum_best_configs:
        config = moe_sum_best_configs[min(moe_sum_best_configs.keys(), key=lambda x: abs(x[0] - M))]
    else:
        if M < 32:
...
def inplace_fused_experts(hidden_states: torch.Tensor,
    ...
    fused_experts_impl(hidden_states, w1, w2, topk_weights, topk_ids, True,
                       ...
                       use_int4_w4a16,per_channel_quant, global_num_experts, expert_map,
...
def fused_experts(hidden_states: torch.Tensor,
    ...
    if inplace:
        torch.ops.vllm.inplace_fused_experts(
            ...
            use_fp8_w8a8, use_int8_w8a8, use_int8_w8a16, use_int4_w4a16,per_channel_quant, global_num_experts,
