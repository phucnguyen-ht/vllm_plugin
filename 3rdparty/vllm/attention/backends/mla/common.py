...
from vllm.attention.fa_utils import get_flash_attn_version
...
class MLACommonImpl(MLAAttentionImpl[T], Generic[T]):
    ...
    def _forward_prefill(
        ...
        if is_hip and envs.VLLM_USE_TRITON_FLASH_ATTN and not has_context:
            ...
            output = _C_flashattention.varlen_fwd_bshd(
                q, # 32768, 12, 128
                k, # 32768, 2, 128
                v_padded, # 32768, 2, 128
                None,
                prefill_metadata.query_start_loc,  # 257
                prefill_metadata.query_start_loc,  # 257
                None,
                None,
                prefill_metadata.max_prefill_seq_len,  # 128
                prefill_metadata.max_prefill_seq_len,  # 128
                0.0,
                self.scale,  # float
                False,
