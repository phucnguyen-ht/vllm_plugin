...
from vllm.attention.fa_utils import (flash_attn_supports_fp8,
    ...
    def forward(
        ...
        if kv_cache.numel() > 0:
            ...
            if (attn_type != AttentionType.ENCODER) and (key is not None) and (
                ...
                #     layer._v_scale,
                # )
                PagedAttention.write_to_paged_rocm_flash_cache(
                    key,  # key 256 2 128
                    value,  # value 256 2 128
                    key_cache,  # keycache 6544 2 128 128
                    value_cache,  # valuecache 2 6544 2 128 128
                    updated_slot_mapping,  # 256
                    kv_cache_dtype,  # auto
                    1.0
                )
        ...
        if prefill_meta := attn_metadata.prefill_metadata:
            ...
            if (kv_cache.numel() == 0 or prefill_meta.block_tables is None
                ...
                output[:num_prefill_query_tokens] = _C_flashattention.varlen_fwd_bshd(
                    query, # 32768, 12, 128
                    key, # 32768, 2, 128
                    value, # 32768, 2, 128
                    None,
        ...
        if decode_meta := attn_metadata.decode_metadata:
            ...
            decode_query1 = decode_query.unsqueeze(2).contiguous()
            ...
            if decode_meta.max_decode_query_len > 1:
                ...
                _C_flashattention.fwd_kvcache(
                                decode_query1,  # 256, 12, 1, 128
                                key_cache,  # 6530, 2, 128, 128  # 52444, 2, 16, 128  # 6269, 2, 128, 128
                                value_cache,  # 6530, 2, 128, 128  # 52444, 2, 16, 128  # 6269, 2, 128, 128
                                None,
                                None,
                                None,
                                decode_meta.seq_lens_tensor,  # 256  #
                                decode_meta.max_decode_query_len,  # 1  #
                                None,
                                None,
                                None,
                                None,
                                decode_meta.block_tables,  # 256, 64
                                None,
                                decode_output,  # 256, 12, 1, 128
                                softmax_scale,  # float
                                False,
                                -1,
                                -1,
                                logits_soft_cap,  # 0
                                False,
                                -1 if attn_metadata.use_cuda_graph else 0,
                                None,
                                None)   
