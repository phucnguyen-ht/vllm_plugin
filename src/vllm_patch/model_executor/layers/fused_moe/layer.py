...
from vllm_patch.model_executor.layers.fused_moe.config import (
...
from vllm_patch.model_executor.layers.fused_moe.modular_kernel import (
    FusedMoEActivationFormat,
    FusedMoEModularKernel,
    FusedMoEPermuteExpertsUnpermute,
    FusedMoEPrepareAndFinalize,
)
from vllm_patch.model_executor.layers.fused_moe.rocm_aiter_fused_moe import (
...
from vllm.utils import cdiv, direct_register_custom_op, round_up
from vllm_patch.utils import has_deep_ep, has_pplx
...
@CustomOp.register("custom_fused_moe")
class CustomFusedMoE(CustomOp):
    ...
    def __init__(
        ...
        moe = FusedMoEConfig(
            ...
            max_num_tokens=(envs.VLLM_MOE_DP_CHUNK_SIZE if hasattr(envs, 'VLLM_MOE_DP_CHUNK_SIZE') else 256),
            has_bias=has_bias,
        )
        self.moe_config = moe
        self.moe_quant_config: FusedMoEQuantConfig | None = None
    ...
    def weight_loader(
        ...
        if self.quant_config and "mxfp4" in self.quant_config.get_name():
    ...
    def forward_native(
        ...
        if self.shared_experts is None:
            if current_platform.is_tpu():
                ...
                fused_output = torch.ops.vllm.patch_moe_forward(
...
direct_register_custom_op(
    op_name="patch_moe_forward",
    op_func=patch_moe_forward,
    mutates_args=["hidden_states"],
    fake_impl=patch_moe_forward_fake,
...
CustomFusedMoE.weight_loader.supports_moe_loading = True  # type: ignore[attr-defined]
